...
%if  (a_Start_deg>=270  && a_End_deg < 90)%((abs(a_End_deg -a_Start_deg)) < 90 || (abs(a_End_deg -a_Start_deg))) > 180 %&& ((a_End_deg <= 270 && a_Start_deg <= 0) || (a_Start_deg <= 270 && a_End_deg <= 0))
...
% elseif  ((a_End_deg >= 270 && 90 > a_Start_deg >= 0) || (a_Start_deg >= 270 && a_End_deg >= 0))
...
%% Mittlere Punkte
% if abs(a_End_deg -a_Start_deg) <=180 % a_End_deg <= 270 && a_Start_deg <= 270
%     angle= abs(a_End_deg -a_Start_deg);                  %Oeffnungswinkel
%     %angle =90;
% elseif (a_End_deg >= 270 && a_Start_deg >= 0) || (a_Start_deg >= 270 && a_End_deg>=0)
...
%% Mittleren Punkt berechen Option 2
